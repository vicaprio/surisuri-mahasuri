...
function Home() {
  ...
  const faqs = [
    ...
    {
      question: '하자이행보증서는 어떻게 받나요?',
      answer: '수리 완료 후 자동으로 디지털 AS 하자이행보증서가 발급됩니다. 마이페이지의 수리 이력에서 언제든지 확인 및 다운로드할 수 있으며, 보증 기간 내 무상 AS를 받으실 수 있습니다.'
    },
    {
    ...
    },
    {
      ...
      answer: '네, 견적 확인과 기사님 매칭을 위해 회원가입이 필요합니다. 하지만 구글, 네이버, 카카오 계정으로 간편하게 가입할 수 있으며, 가입 후 수리 이력과 하자이행보증서를 체계적으로 관리하실 수 있습니다.'
    }
  ];
